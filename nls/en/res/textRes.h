...
#define SZ_SDTIMWARPCENTER       "Save ~eComCenter settings :"
...
#define SZ_SSDWNCOMPLETE    "Shutdown is complete."
...
#define SZ_SSDWNPWRINGOFF   "The system will power off once shutdown is "\
                            "complete."
#define SZ_SSDWNSWTCHOFF    "You may safely power off the computer."
...
#define SZ_WKEYITEM09       "Show eComCenter desktop menu"
#define SZ_WKEYITEM10       "Show eComCenter window list"
#define SZ_WKEYITEM11       "Show eComCenter process list"
#define SZ_WKEYITEM12       "Show eComCenter tray list"
#define SZ_WKEYITEM13       "Switch to the next eComCenter tray"
#define SZ_WKEYITEM14       "Show eComCenter information menu"
